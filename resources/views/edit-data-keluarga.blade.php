                ...
                <div class="card collapsed-card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-5">
                                <div class="form-group">
                                    <input type="text" class="form-control @error('no_kk') is-invalid @enderror" id="inputNoKartuKeluarga" name="no_kk" placeholder="Nomer Kartu Keluarga (KK)" value="{{ $keluarga->no_kk }}">
                                    @error('no_kk') <span class="text-danger">{{$message}}</span> @enderror
                                </div>
                            </div>
                            <div class="col-3">
                                <div class="form-group">
                                    <input type="text" class="form-control @error('tempat_lahir') is-invalid @enderror" id="inputTempatLahir" name="tempat_lahir" placeholder="Tempat Lahir" value="{{ $keluarga->tempat_lahir }}">
                            ...
                            <div class="col-4">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="date" class="form-control @error('tanggal_lahir') is-invalid @enderror" id="inputTanggalLahir" name="tanggal_lahir" placeholder="Tanggal Lahir" value="{{ $keluarga->tanggal_lahir }}">
                        ...
                        <div class="row">
                            <div class="col-5">
                                <div class="form-group">
                                    <input type="text" class="form-control @error('nik') is-invalid @enderror" id="inputNIK" name="nik" placeholder="Nomor Induk Kependudukan (NIK)" value="{{ $keluarga->nik }}">
                                ...
                                <div class="form-group">
                                    <select class="form-control @error('cluster_wilayah_id') is-invalid @enderror" id="inputClusterWilayah" name="cluster_wilayah_id">
                                        ...
                                        @foreach ($cluster_wilayah as $ref_cluster_wilayah)
                                            <option value="{{ $ref_cluster_wilayah->id }}" @if ($keluarga->cluster_wilayah_id == $ref_cluster_wilayah->id) selected @endif>{{ 'RT '.$ref_cluster_wilayah->rt.' - RW '.$ref_cluster_wilayah->rw.' - Lingk. '.$ref_cluster_wilayah->lingkungan.' - Kel. '.$ref_cluster_wilayah->kelurahan.' - Kec. '.$ref_cluster_wilayah->kecamatan }}</option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="row">
                            <div class="col-5">
                                <div class="form-group">
                                    <input type="text" class="form-control @error('nama_kepala') is-invalid @enderror" name="nama_kepala" id="inputNamaKepalaKeluarga" placeholder="Nama Kepala Keluarga" value="{{ $keluarga->nama_kepala }}">
                                    @error('nama_kepala') <span class="text-danger">{{$message}}</span> @enderror
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    <input type="text" class="form-control @error('jumlah_anggota') is-invalid @enderror" id="inputJumlahAnggotaKeluarga" name="jumlah_anggota" placeholder="Jumlah Anggota Keluarga" value="{{ $keluarga->jumlah_anggota }}">
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control @error('ref_pendapatan_suami_id') is-invalid @enderror" id="inputPendapatan-Suami" name="ref_pendapatan_suami_id">
                                            ...
                                            @foreach ($pendapatan as $ref_pendapatan)
                                                <option value="{{ $ref_pendapatan->id }}" @if ($potensi_keluarga->ref_pendapatan_suami_id == $ref_pendapatan->id) selected @endif>{{ $ref_pendapatan->nama }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control @error('ref_pendapatan_istri_id') is-invalid @enderror" id="inputPendapatan-Istri" name="ref_pendapatan_istri_id">
                                            ...
                                            @foreach ($pendapatan as $ref_pendapatan)
                                                <option value="{{ $ref_pendapatan->id }}" @if ($potensi_keluarga->ref_pendapatan_istri_id == $ref_pendapatan->id) selected @endif>{{ $ref_pendapatan->nama }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control @error('ref_pendapatan_anak_id') is-invalid @enderror" id="inputPendapatan-Anak" name="ref_pendapatan_anak_id">
                                            ...
                                            @foreach ($pendapatan as $ref_pendapatan)
                                                <option value="{{ $ref_pendapatan->id }}" @if ($potensi_keluarga->ref_pendapatan_anak_id == $ref_pendapatan->id) selected @endif>{{ $ref_pendapatan->nama }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control @error('ref_pendapatan_orangtua_id') is-invalid @enderror" id="inputPendapatan-OrangTua" name="ref_pendapatan_orangtua_id">
                                            ...
                                            @foreach ($pendapatan as $ref_pendapatan)
                                                <option value="{{ $ref_pendapatan->id }}" @if ($potensi_keluarga->ref_pendapatan_orangtua_id == $ref_pendapatan->id) selected @endif>{{ $ref_pendapatan->nama }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control @error('ref_alat_transportasi_id') is-invalid @enderror" id="inputRumahTangga-Transportasi" name="ref_alat_transportasi_id">
                                            ...
                                            @foreach ($alat_transportasi as $ref_alat_transportasi)
                                                <option value="{{ $ref_alat_transportasi->id }}" @if ($potensi_keluarga->ref_alat_transportasi_id == $ref_alat_transportasi->id) selected @endif>{{ $ref_alat_transportasi->nama }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control @error('ref_alat_penerangan_id') is-invalid @enderror" id="inputRumahTangga-Penerangan" name="ref_alat_penerangan_id">
                                            ...
                                            @foreach ($alat_penerangan as $ref_alat_penerangan)
                                                <option value="{{ $ref_alat_penerangan->id }}" @if ($potensi_keluarga->ref_alat_penerangan_id == $ref_alat_penerangan->id) selected @endif>{{ $ref_alat_penerangan->nama }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control @error('ref_daya_listrik_id') is-invalid @enderror" id="inputRumahTangga-DayaListrik" name="ref_daya_listrik_id">
                                            ...
                                            @foreach ($daya_listrik as $ref_daya_listrik)
                                                <option value="{{ $ref_daya_listrik->id }}" @if ($potensi_keluarga->ref_daya_listrik_id == $ref_daya_listrik->id) selected @endif>{{ $ref_daya_listrik->nama }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control @error('ref_sarana_air_bersih_id') is-invalid @enderror" id="inputRumahTangga-SaranaAirBersih" name="ref_sarana_air_bersih_id">
                                            ...
                                            @foreach ($sarana_air_bersih as $ref_sarana_air_bersih)
                                                <option value="{{ $ref_sarana_air_bersih->id }}" @if ($potensi_keluarga->ref_sarana_air_bersih_id == $ref_sarana_air_bersih->id) selected @endif>{{ $ref_sarana_air_bersih->nama }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control @error('ref_kemampuan_berobat_id') is-invalid @enderror" id="inputRumahTangga-KemampuanBerobat" name="ref_kemampuan_berobat_id">
                                            ...
                                            @foreach ($kemampuan_berobat as $ref_kemampuan_berobat)
                                                <option value="{{ $ref_kemampuan_berobat->id }}" @if ($potensi_keluarga->ref_kemampuan_berobat_id == $ref_kemampuan_berobat->id) selected @endif>{{ $ref_kemampuan_berobat->nama }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control @error('ref_jenis_jamban_id') is-invalid @enderror" id="inputRumahTangga-JenisJamban" name="ref_jenis_jamban_id">
                                            ...
                                            @foreach ($jenis_jamban as $ref_jenis_jamban)
                                                <option value="{{ $ref_jenis_jamban->id }}" @if ($potensi_keluarga->ref_jenis_jamban_id == $ref_jenis_jamban->id) selected @endif>{{ $ref_jenis_jamban->nama }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control @error('ref_jenis_septitank_id') is-invalid @enderror" id="inputRumahTangga-Septitank" name="ref_jenis_septitank_id">
                                            ...
                                            @foreach ($jenis_septitank as $ref_jenis_septitank)
                                                <option value="{{ $ref_jenis_septitank->id }}" @if ($potensi_keluarga->ref_jenis_septitank_id == $ref_jenis_septitank->id) selected @endif>{{ $ref_jenis_septitank->nama }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control @error('ref_bahan_bakar_id') is-invalid @enderror" id="inputRumahTangga-BahanBakar" name="ref_bahan_bakar_id">
                                            ...
                                            @foreach ($bahan_bakar as $ref_bahan_bakar)
                                                <option value="{{ $ref_bahan_bakar->id }}" @if ($potensi_keluarga->ref_bahan_bakar_id == $ref_bahan_bakar->id) selected @endif>{{ $ref_bahan_bakar->nama }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control @error('ref_jenis_pembuangan_id') is-invalid @enderror" id="inputRumahTangga-JenisPembuangan" name="ref_jenis_pembuangan_id">
                                            ...
                                            @foreach ($jenis_pembuangan as $ref_jenis_pembuangan)
                                                <option value="{{ $ref_jenis_pembuangan->id }}" @if ($potensi_keluarga->ref_jenis_pembuangan_id == $ref_jenis_pembuangan->id) selected @endif>{{ $ref_jenis_pembuangan->nama }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control @error('ref_jenis_pemilahan_id') is-invalid @enderror" id="inputRumahTangga-Pemilahan" name="ref_jenis_pemilahan_id">
                                            ...
                                            @foreach ($jenis_pemilahan as $ref_jenis_pemilahan)
                                                <option value="{{ $ref_jenis_pemilahan->id }}" @if ($potensi_keluarga->ref_jenis_pemilahan_id == $ref_jenis_pemilahan->id) selected @endif>{{ $ref_jenis_pemilahan->nama }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control @error('ref_kepemilikan_tabungan_id') is-invalid @enderror" id="inputRumahTangga-KepemilikanTabungan" name="ref_kepemilikan_tabungan_id">
                                            ...
                                            @foreach ($kepemilikan_tabungan as $ref_kepemilikan_tabungan)
                                                <option value="{{ $ref_kepemilikan_tabungan->id }}" @if ($potensi_keluarga->ref_kepemilikan_tabungan_id == $ref_kepemilikan_tabungan->id) selected @endif>{{ $ref_kepemilikan_tabungan->nama }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control @error('ref_kepemilikan_emas_id') is-invalid @enderror" id="inputRumahTangga-KepemilikanEmas" name="ref_kepemilikan_emas_id">
                                            ...
                                            @foreach ($kepemilikan_emas as $ref_kepemilikan_emas)
                                                <option value="{{ $ref_kepemilikan_emas->id }}" @if ($potensi_keluarga->ref_kepemilikan_emas_id == $ref_kepemilikan_emas->id) selected @endif>{{ $ref_kepemilikan_emas->nama }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control @error('ref_sarana_prasarana_id') is-invalid @enderror" id="inputRumahTangga-SarprasKeluarga" name="ref_sarana_prasarana_id">
                                            ...
                                            @foreach ($sarana_prasarana as $ref_sarana_prasarana)
                                                <option value="{{ $ref_sarana_prasarana->id }}" @if ($potensi_keluarga->ref_sarana_prasarana_id == $ref_sarana_prasarana->id) selected @endif>{{ $ref_sarana_prasarana->nama }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control @error('ref_kemampuan_beli_pakaian_id') is-invalid @enderror" id="inputRumahTangga-BeliPakaian" name="ref_kemampuan_beli_pakaian_id">
                                            ...
                                            @foreach ($kemampuan_beli_pakaian as $ref_kemampuan_beli_pakaian)
                                                <option value="{{ $ref_kemampuan_beli_pakaian->id }}" @if ($potensi_keluarga->ref_kemampuan_beli_pakaian_id == $ref_kemampuan_beli_pakaian->id) selected @endif>{{ $ref_kemampuan_beli_pakaian->nama }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control @error('ref_dinding_id') is-invalid @enderror" id="inputRumah-Dinding" name="ref_dinding_id">
                                            ...
                                            @foreach ($dinding as $ref_dinding)
                                                <option value="{{ $ref_dinding->id }}" @if ($potensi_keluarga->ref_dinding_id == $ref_dinding->id) selected @endif>{{ $ref_dinding->nama }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control @error('ref_atap_id') is-invalid @enderror" id="inputRumah-Atap" name="ref_atap_id">
                                            ...
                                            @foreach ($atap as $ref_atap)
                                                <option value="{{ $ref_atap->id }}" @if ($potensi_keluarga->ref_atap_id == $ref_atap->id) selected @endif>{{ $ref_atap->nama }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control @error('ref_lantai_id') is-invalid @enderror" id="inputRumah-Lantai" name="ref_lantai_id">
                                            ...
                                            @foreach ($lantai as $ref_lantai)
                                                <option value="{{ $ref_lantai->id }}" @if ($potensi_keluarga->ref_lantai_id == $ref_lantai->id) selected @endif>{{ $ref_lantai->nama }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control @error('ref_surat_tanah_id') is-invalid @enderror" id="inputRumah-SuratTanah" name="ref_surat_tanah_id">
                                            ...
                                            @foreach ($surat_tanah as $ref_surat_tanah)
                                                <option value="{{ $ref_surat_tanah->id }}" @if ($potensi_keluarga->ref_surat_tanah_id == $ref_surat_tanah->id) selected @endif>{{ $ref_surat_tanah->nama }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control @error('ref_status_kepemilikan_rumah_id') is-invalid @enderror" id="inputRumah-StatusKepemilikan" name="ref_status_kepemilikan_rumah_id">
                                            ...
                                            @foreach ($status_milik_rumah as $ref_status_kepemilikan_rumah)
                                                <option value="{{ $ref_status_kepemilikan_rumah->id }}" @if ($potensi_keluarga->ref_status_kepemilikan_rumah_id == $ref_status_kepemilikan_rumah->id) selected @endif>{{ $ref_status_kepemilikan_rumah->nama }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control @error('ref_ukuran_rumah_id') is-invalid @enderror" id="inputRumah-UkuranTanah" name="ref_ukuran_rumah_id">
                                            ...
                                            @foreach ($ukuran_rumah as $ref_ukuran_rumah)
                                                <option value="{{ $ref_ukuran_rumah->id }}" @if ($potensi_keluarga->ref_ukuran_rumah_id == $ref_ukuran_rumah->id) selected @endif>{{ $ref_ukuran_rumah->nama }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control @error('ref_luas_pekarangan_id') is-invalid @enderror" id="inputRumah-LuasTanahPekarangan" name="ref_luas_pekarangan_id">
                                            ...
                                            @foreach ($luas_pekarangan as $ref_luas_pekarangan)
                                                <option value="{{ $ref_luas_pekarangan->id }}" @if ($potensi_keluarga->ref_luas_pekarangan_id == $ref_luas_pekarangan->id) selected @endif>{{ $ref_luas_pekarangan->nama }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control @error('ref_ukuran_lahan_sawah_id') is-invalid @enderror" id="inputSawah-Ukuran" name="ref_ukuran_lahan_sawah_id">
                                            ...
                                            @foreach ($ukuran_lahan as $ref_ukuran_lahan_sawah)
                                                <option value="{{ $ref_ukuran_lahan_sawah->id }}" @if ($potensi_keluarga->ref_ukuran_lahan_sawah_id == $ref_ukuran_lahan_sawah->id) selected @endif>{{ $ref_ukuran_lahan_sawah->nama }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control @error('ref_status_kepemilikan_sawah_id') is-invalid @enderror" id="inputSawah-StatusKepemilikan" name="ref_status_kepemilikan_sawah_id">
                                            ...
                                            @foreach ($status_milik_lahan as $ref_status_kepemilikan_sawah)
                                                <option value="{{ $ref_status_kepemilikan_sawah->id }}" @if ($potensi_keluarga->ref_status_kepemilikan_sawah_id == $ref_status_kepemilikan_sawah->id) selected @endif>{{ $ref_status_kepemilikan_sawah->nama }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control @error('ref_ukuran_lahan_kebun_id') is-invalid @enderror" id="inputKebun-Ukuran" name="ref_ukuran_lahan_kebun_id">
                                            ...
                                            @foreach ($ukuran_lahan as $ref_ukuran_lahan_kebun)
                                                <option value="{{ $ref_ukuran_lahan_kebun->id }}" @if ($potensi_keluarga->ref_ukuran_lahan_kebun_id == $ref_ukuran_lahan_kebun->id) selected @endif>{{ $ref_ukuran_lahan_kebun->nama }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control @error('ref_status_kepemilikan_kebun_id') is-invalid @enderror" id="inputKebun-StatusKepemilikan" name="ref_status_kepemilikan_kebun_id">
                                            ...
                                            @foreach ($status_milik_lahan as $ref_status_kepemilikan_kebun)
                                                <option value="{{ $ref_status_kepemilikan_kebun->id }}" @if ($potensi_keluarga->ref_status_kepemilikan_kebun_id == $ref_status_kepemilikan_kebun->id) selected @endif>{{ $ref_status_kepemilikan_kebun->nama }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control @error('ref_kepemilikan_ternak_besar_id') is-invalid @enderror" id="inputTernakBesar-Kepemilikan" name="ref_kepemilikan_ternak_besar_id">
                                            ...
                                            @foreach ($kepemilikan_ternak as $ref_kepemilikan_ternak_besar)
                                                <option value="{{ $ref_kepemilikan_ternak_besar->id }}" @if ($potensi_keluarga->ref_status_kepemilikan_ternak_besar_id == $ref_kepemilikan_ternak_besar->id) selected @endif>{{ $ref_kepemilikan_ternak_besar->nama }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control @error('ref_status_kepemilikan_ternak_besar_id') is-invalid @enderror" id="inputTernakBesar-StatusKepemilikan" name="ref_status_kepemilikan_ternak_besar_id">
                                            ...
                                            @foreach ($status_milik_ternak as $ref_status_kepemilikan_ternak_besar)
                                                <option value="{{ $ref_status_kepemilikan_ternak_besar->id }}" @if ($potensi_keluarga->ref_status_kepemilikan_ternak_besar_id == $ref_status_kepemilikan_ternak_besar->id) selected @endif>{{ $ref_status_kepemilikan_ternak_besar->nama }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control @error('ref_kepemilikan_ternak_kecil_id') is-invalid @enderror" id="inputTernakKecil-Kepemilikan" name="ref_kepemilikan_ternak_kecil_id">
                                            ...
                                            @foreach ($kepemilikan_ternak as $ref_kepemilikan_ternak_kecil)
                                                <option value="{{ $ref_kepemilikan_ternak_kecil->id }}" @if ($potensi_keluarga->ref_kepemilikan_ternak_kecil_id == $ref_kepemilikan_ternak_kecil->id) selected @endif>{{ $ref_kepemilikan_ternak_kecil->nama }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control @error('ref_status_kepemilikan_ternak_kecil_id') is-invalid @enderror" id="inputTernakKecil-StatusKepemilikan" name="ref_status_kepemilikan_ternak_kecil_id">
                                            ...
                                            @foreach ($status_milik_ternak as $ref_status_kepemilikan_ternak_kecil)
                                                <option value="{{ $ref_status_kepemilikan_ternak_kecil->id }}" @if ($potensi_keluarga->ref_status_kepemilikan_ternak_kecil_id == $ref_status_kepemilikan_ternak_kecil->id) selected @endif>{{ $ref_status_kepemilikan_ternak_kecil->nama }}</option>
                                            @endforeach
                                        </select>
